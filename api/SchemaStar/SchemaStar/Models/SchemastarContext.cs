...
public partial class SchemastarContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.PublicId)
                .HasMaxLength(16)
                .HasDefaultValueSql("UUID_TO_BIN(UUID(),1)") //Removed internal single quotes
                .ValueGeneratedOnAdd() //Tells EF to read it after Insert, Generated by the database
                .IsFixedLength()
                .HasColumnName("public_id");
            entity.Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate() //Telss Ef to read it after Insert or Update, Generated by the database
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("timestamp")
                .HasColumnName("updated_at");
