...
namespace SchemaStar.Migrations
{
    ...
    [Migration("20260622003042_NodeAssetSoftDeletion")]
    partial class NodeAssetSoftDeletion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchemaStar.Models.Node", b =>
                {
                    ...
                    b.HasIndex(new[] { "IsDeleted", "NodeWebId" }, "ix_node_web_active");
            ...
            modelBuilder.Entity("SchemaStar.Models.NodeAsset", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
                    ...
                    b.Property<string>("NodeAssetName")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)")
                        .HasColumnName("node_asset_name");

                    b.Property<string>("NodeAssetSource")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("NodeAssetType")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex(new[] { "IsDeleted", "NodeId" }, "ix_node_active");

                    b.HasIndex(new[] { "NodeId" }, "node_id");

                    b.HasIndex(new[] { "PublicId" }, "public_id")
                        .IsUnique()
                        .HasDatabaseName("public_id2");

                    b.ToTable("node_asset", (string)null);
                });
            ...
            modelBuilder.Entity("SchemaStar.Models.NodeAsset", b =>
                {
                    b.HasOne("SchemaStar.Models.Node", "Node")
                        .WithMany("NodeAssets")
